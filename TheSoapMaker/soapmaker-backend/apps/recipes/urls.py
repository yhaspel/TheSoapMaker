...
urlpatterns = [
    ...
    path("recipes/bookmarked/", BookmarkedRecipesView.as_view(), name="recipe-bookmarked"),
    ...
    path("recipes/<slug:slug>/bookmark/", BookmarkToggleView.as_view(), name="recipe-bookmark"),
