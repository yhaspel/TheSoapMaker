...
@Component({
    ...
    <div class="auth-page">
      <div class="auth-card">
        ...
        <div class="social-btns">
          ...
          <button class="social-btn social-btn--twitter" (click)="socialLogin('twitter')">
  ...
  styles: [`
    ...
    .auth-card { width: 100%; max-width: 420px; background: #fff9f3; border: 1px solid #e5d9ca; border-radius: 16px; padding: 2.5rem; box-shadow: 0 8px 32px rgba(0,0,0,.10); }
